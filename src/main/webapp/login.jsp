...
<html lang="en">
  ...
  <body>
    ...
    <section id="login">
      ...
      {	  
       %>
         <h3 style="color: red; margin-top:8px;font-size:1rem">Registration successful...Please Login</h3>
          <%} %>   
      ...
      {	  
       %>
         <h1 style="color:yellow">Something is wrong!</h1>
       <%} %>
       <%
      if("notextist".equals(msg))
      {	  
       %>
         <h1 style="color:red;font-size:1rem;margin-top:8px" >Email or Password does not match </h1>
         <%} %>
        ...
        <div class="sign-up">
        <br>
          <a href="sign-up.jsp" style="text-decoration:none">Sign Up</a>
          <br>
        </div>
        </form>
      </div>
