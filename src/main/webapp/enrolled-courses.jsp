        ...
        <ul>
          ...
          <li class="dropdown">
            ...
            <div class="dropdown-content">
              ...
              <a class="active" href="enrolled-courses.jsp"
                >Enrolled Courses</a
              >
            </div>
          </li>
...
try{
	  ...
	  ResultSet rs=st.executeQuery("select * from payment where emailId='"+emailID+"' ");
	while(rs.next())
	{
%>
<td> <%=rs.getInt(7)    %></td>
...
<td> <%="Enrolled" %></td>
<td> <a href="www.youtube.com">Go to Lectures</a></td>

<%-- <td> <a href="deleteDonor.jsp?id=<%=re.getString(1)%>"> <i class="fa-solid fa-trash-can"></i>Delete </a></td> --%>
